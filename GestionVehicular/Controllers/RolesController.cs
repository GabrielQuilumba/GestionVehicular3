...
public class RolesController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("RolId,Nombre,EsActivo,FechaCreacion")] Role role)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("RolId,Nombre,EsActivo,FechaCreacion")] Role role)
    {
        if (id != role.RolId)
        {
            return NotFound();
